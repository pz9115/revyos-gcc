...
(define_insn "*zero_extendsidi2_bitmanip"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r,r,r")
	(zero_extend:DI (match_operand:SI 1 "nonimmediate_operand" "r,Qmu,Qmr,Qma,Qmb,m")))]
  ...
  "@
   ...
   lwuib\t%0,%1
   lwu\t%0,%1"
  [(set_attr "type" "bitmanip,load,load,load,load,load")
   (set_attr "mode" "DI")])
...
(define_insn "*zero_extendhi<GPR:mode>2_bitmanip"
  [(set (match_operand:GPR 0 "register_operand" "=r,r,r,r,r,r")
	(zero_extend:GPR (match_operand:HI 1 "nonimmediate_operand" "r,Qmu,Qmr,Qma,Qmb,m")))]
  "TARGET_ZBB"
  "@
   zext.h\t%0,%1
   lurhu\t%0,%1
...
(define_insn "*zero_extendhi<GPR:mode>2_zbb"
  [(set (match_operand:GPR    0 "register_operand"     "=r,r,r,r,r,r,r")
	(zero_extend:GPR
	    (match_operand:HI 1 "nonimmediate_operand" " r,m,Qmu,Qmr,Qma,Qmb,m")))]
  "TARGET_ZBB"
  "@
   zext.h\t%0,%1
   lhu\t%0,%1
   ...
   lhib\t%0,%1
   lh\t%0,%1"
  [(set_attr "type" "bitmanip,load,load,load,load,load,load")
   (set_attr "mode" "HI")])

(define_insn "riscv_rotrsi3"
  [(set (match_operand:SI 0 "register_operand" "=r")
