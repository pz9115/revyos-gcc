...
#define _RVV_QINT_SEW8_ITERATOR(MACRO) \
  MACRO (8, f2, 16, vnx8qi, QI, 32, vnx2si, SI) \
  MACRO (8, 1, 8, vnx16qi, QI, 32, vnx4si, SI) \
  MACRO (8, 2, 4, vnx32qi, QI, 32, vnx8si, SI) \
  MACRO (8, 4, 2, vnx64qi, QI, 32, vnx16si, SI) \
  MACRO (8, 8, 1, vnx128qi, QI, 32, vnx32si, SI) \

/* Same as above but with an extra argument.  */
#define _RVV_QINT_SEW8_ITERATOR_ARG(MACRO, ...) \
  MACRO (8, f2, 16, vnx8qi, QI, 32, vnx2si, SI, __VA_ARGS__) \
  MACRO (8, 1, 8, vnx16qi, QI, 32, vnx4si, SI, __VA_ARGS__) \
  MACRO (8, 2, 4, vnx32qi, QI, 32, vnx8si, SI, __VA_ARGS__) \
  MACRO (8, 4, 2, vnx64qi, QI, 32, vnx16si, SI, __VA_ARGS__) \
  MACRO (8, 8, 1, vnx128qi, QI, 32, vnx32si, SI, __VA_ARGS__) \
