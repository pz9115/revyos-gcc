...
#define MTEST(TYPE_T, STYPE, TYPE)  \
  void test_msub_##TYPE(m##TYPE_T *temp1, m##TYPE_T *temp2, m##TYPE_T *temp3, m##TYPE_T *temp4, m##TYPE_T x, m##TYPE_T y, TYPE_T z, uint8_t stride) {  \
    *temp1 = msub_m##STYPE(x, y);  \
    *temp2 = msub_m##STYPE##_m##STYPE##v(x, y, stride);  \
    *temp3 = msub_m##STYPE##_m##STYPE##v(x, y, 2);  \
    *temp4 = msub_m##STYPE##_##STYPE(x, z);  \
  }
