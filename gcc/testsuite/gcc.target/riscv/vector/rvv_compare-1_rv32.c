...
#define VCOMPARE_VV(STYPE, VCLASST, VCLASS, EM, MLEN, STYPEC, SEW, OP)                               \
  void v##OP##VCLASS##EM##_vv(size_t n, STYPE *x, STYPE *y, STYPE z, word_type vl) {         \
    ...
    mask = vms##OP##_vv_##VCLASS##EM##_b##MLEN(vx, vy, vl);                                 \
...
#define VCOMPARE_VX(STYPE, VCLASST, VCLASS, EM, MLEN, STYPEC, SEW, OP)                               \
  void v##OP##VCLASS##EM##_vx(size_t n, STYPE *x, STYPE *y, STYPE z, word_type vl) {         \
    ...
    vx = VLOAD(VCLASS, SEW, EM, x);                                               \
    vy = VLOAD(VCLASS, SEW, EM, y);                                               \
    mask = vms##OP##_vx_##VCLASS##EM##_b##MLEN(vx, z, vl);                            \
    vx = vadd_vv_##VCLASS##EM##_m (mask, vy, vx, vy, vl);                    \
    VSTORE(VCLASS, SEW, EM, x, vx);                                                \
  }
...
#define VCOMPARE_VI(STYPE, VCLASST, VCLASS, EM, MLEN, STYPEC, SEW, OP)                               \
  void v##OP##VCLASS##EM##_vi(size_t n, STYPE *x, STYPE *y, STYPE z, word_type vl) {         \
    ...
    vx = VLOAD(VCLASS, SEW, EM, x);                                               \
    vy = VLOAD(VCLASS, SEW, EM, y);                                               \
    mask = vms##OP##_vx_##VCLASS##EM##_b##MLEN(vx, 12, vl);                           \
    vx = vadd_vv_##VCLASS##EM##_m (mask, vy, vx, vy, vl);                    \
    VSTORE(VCLASS, SEW, EM, x, vx);                                                \
  }
...
/* { dg-final { scan-assembler-times "vmseq.vv" 60 } } */
/* { dg-final { scan-assembler-times "vmseq.vx" 36 } } */
/* { dg-final { scan-assembler-times "vmseq.vi" 36 } } */
RVV_INT_TEST_ARG(TEST_COMPARE_VV_VX_VI, ne)
RVV_UINT_TEST_ARG(TEST_COMPARE_VV_VX_VI, ne)
/* { dg-final { scan-assembler-times "vmsne.vv" 60 } } */
/* { dg-final { scan-assembler-times "vmsne.vx" 36 } } */
/* { dg-final { scan-assembler-times "vmsne.vi" 36 } } */
RVV_INT_TEST_ARG(TEST_COMPARE_VV_VX, lt)
/* { dg-final { scan-assembler-times "vmslt.vv" 26 } } */
/* { dg-final { scan-assembler-times "vmslt.vx" 18 } } */
RVV_UINT_TEST_ARG(TEST_COMPARE_VV_VX, ltu)
/* { dg-final { scan-assembler-times "vmsltu.vv" 26 } } */
/* { dg-final { scan-assembler-times "vmsltu.vx" 18 } } */
RVV_INT_TEST_ARG(TEST_COMPARE_VV_VX_VI, le)
/* { dg-final { scan-assembler-times "vmsle.vv" 30 } } */
/* { dg-final { scan-assembler-times "vmsle.vx" 18 } } */
/* { dg-final { scan-assembler-times "vmsle.vi" 18 } } */
RVV_UINT_TEST_ARG(TEST_COMPARE_VV_VX_VI, leu)
/* { dg-final { scan-assembler-times "vmsleu.vv" 30 } } */
/* { dg-final { scan-assembler-times "vmsleu.vx" 18 } } */
/* { dg-final { scan-assembler-times "vmsleu.vi" 18 } } */
RVV_INT_TEST_ARG(TEST_COMPARE_VX_VI, gt)
/* { dg-final { scan-assembler-times "vmsgt.vx" 18 } } */
/* { dg-final { scan-assembler-times "vmsgt.vi" 18 } } */
RVV_UINT_TEST_ARG(TEST_COMPARE_VX_VI, gtu)
/* { dg-final { scan-assembler-times "vmsgtu.vx" 18 } } */
/* { dg-final { scan-assembler-times "vmsgtu.vi" 18 } } */
