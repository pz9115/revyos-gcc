...
/* { dg-final { scan-assembler-times "vdiv.vv" 30 } } */
/* { dg-final { scan-assembler-times "vdiv.vx" 36 } } */
/* { dg-final { scan-assembler-times "vdivu.vv" 30 } } */
/* { dg-final { scan-assembler-times "vdivu.vx" 36 } } */
