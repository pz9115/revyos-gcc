...
void foo4(int n, double *a, double *b, double *c, double *d, double *e) {
  ...
  for (; vl = vsetvl_e64m8(n); n -= vl) {
    ...
    vec_a = vfadd_vv_f64m8(*(vfloat64m8_t *)a,
            vfadd_vv_f64m8(
              vfdiv_vf_f64m8(
                vfadd_vv_f64m8(*(vfloat64m8_t *)b, *(vfloat64m8_t *)c, vl),
                2, vl),
            vfadd_vv_f64m8(
              vfdiv_vf_f64m8(
                vfadd_vv_f64m8(*(vfloat64m8_t *)d, *(vfloat64m8_t *)e, vl),
                2, vl),
              vfdiv_vf_f64m8(
                vfsub_vv_f64m8(*(vfloat64m8_t *)b, *(vfloat64m8_t *)e, vl),
                2, vl),
            vl), vl), vl);
