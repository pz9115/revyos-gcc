...
/* { dg-final { scan-assembler-times "v(?:macc|madd)\.vv" 208 } } */
/* { dg-final { scan-assembler-times "v(?:macc|madd)\.vx" 144 } } */
/* { dg-final { scan-assembler-times "v(?:nmsac|nmsub)\.vv" 208 } } */
/* { dg-final { scan-assembler-times "v(?:nmsac|nmsub)\.vx" 144 } } */
