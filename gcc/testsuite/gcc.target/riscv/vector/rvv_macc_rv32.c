...
/* { dg-final { scan-assembler-times "v(?:macc|madd)\.vv" 104 } } */
/* { dg-final { scan-assembler-times "v(?:macc|madd)\.vx" 72 } } */
/* { dg-final { scan-assembler-times "v(?:nmsac|nmsub)\.vv" 104 } } */
/* { dg-final { scan-assembler-times "v(?:nmsac|nmsub)\.vx" 72 } } */
