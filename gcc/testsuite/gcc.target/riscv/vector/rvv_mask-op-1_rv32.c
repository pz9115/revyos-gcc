...
/* Takes the scalar type STYPE, vector class VCLASS (int or float), and
   the e and m value.  */
#define VMBIN(STYPE, VCLASST, VCLASS, EM, MLEN, STYPEC, SEW, OP)           \
...
RVV_INT_TEST_ARG(VMNBIN, mandn)
RVV_INT_TEST_ARG(VMNBIN, morn)
/* XXX: vmnot can't generate by oprator now, GCC will ICE.  */
RVV_INT_TEST(VMNOT)

/* { dg-final { scan-assembler-times "vmand.mm" 22 } } */
/* { dg-final { scan-assembler-times "vmor.mm" 22 } } */
/* { dg-final { scan-assembler-times "vmxor.mm" 22 } } */
