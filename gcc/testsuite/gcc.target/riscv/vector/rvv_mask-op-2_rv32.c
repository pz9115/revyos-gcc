...
#define VPOPC(STYPE, VCLASST, VCLASS, EM, MLEN, STYPEC, SEW)                                         \
  ...
  long vpopc##VCLASS##EM##2_m(size_t n, STYPE *x, STYPE *y, STYPE *z, word_type vl) {     \
    ...
    rv = vcpop_m_b##MLEN##_m(mask1, mask2, vl);                           \
    return rv;                                                                 \
  }                                                                            \
  long vpopc##VCLASS##EM##2_m_opt(size_t n, STYPE *x, STYPE *y, STYPE *z, word_type vl) { \
    ...
    mask3 = vmxor_mm_b##MLEN(mask1, mask2, vl);                            \
    rv = vcpop_m_b##MLEN(mask3, vl);                                         \
    return rv;                                                                 \
  }
...
/* { dg-final { scan-assembler-times "vcpop.m" 66 } } */
/* { dg-final { scan-assembler-times "vfirst.m" 44 } } */
/* { dg-final { scan-assembler-times "vid.v" 44 } } */
