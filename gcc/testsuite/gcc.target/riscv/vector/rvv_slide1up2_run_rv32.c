...
void vslide1upu64m1_x_masked_builtin_test (uint64_t *x, uint64_t *y, uint64_t s, size_t vl)
{
    printf("testcase""vslide1up_vx_u64m1_m");
    printf("\n");
    vuint64m1_t vx, vy;
    vbool64_t mask;
    vsetvl_e64m1(vl);
    ...
    vx = vslide1up_vx_u64m1_m(mask, vy, vx, s, vl);
    vse64_v_u64m1 (x, vx, vl);
}
void rvvslide1upu64m1_x_masked_builtin_test_arg()
{
    printf("start test: %s\n", __FUNCTION__);
    ...
    vslide1upu64m1_x_masked_builtin_test(result_uint64, sample_uint64_2, (uint64_t)0x1fffffffffffff, vl);
    for (int i=0; i< len; i++)
    {
...
int main()
{
  ...
  rvvslide1upu64m1_x_masked_builtin_test_arg();
  return 0;
}
/* { dg-output "testcasevslide1up_vx_u64m1_m\r\n" } */
/* { dg-output "1fffffffffffff, 1fffffffffffff, c489e, 3f3d3a, adf01, 7e6c6, 69b8, 6ebd, 7b605, c90a1, 148a0, 28bf29, 11275, db67, 4e3d0a, 99f90, \r\n" } */
