...
#define VSLOADSTORE(STYPE, VCLASST, VCLASS, EM, MLEN, STYPEC, SEW, OP)                                   \
  void vsloadstore##VCLASS##EM(size_t n, long stride, STYPE *x,                \
    ...
    vsse##SEW##_v_##VCLASS##EM##_m(mask, x, stride, vz, vl);                          \
  }
...
/* { dg-final { scan-assembler-times "vsse8.v" 14 } } */
/* { dg-final { scan-assembler-times "vsse16.v" 18 } } */
/* { dg-final { scan-assembler-times "vsse32.v" 15 } } */
