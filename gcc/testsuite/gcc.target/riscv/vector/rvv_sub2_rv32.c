...
/* { dg-final { scan-assembler-times "vsub.vv" 76 } } */
/* { dg-final { scan-assembler-times "vsub.vx" 72 } } */
/* { dg-final { scan-assembler-times "vfsub.vv" 15 } } */
/* { dg-final { scan-assembler-times "vfsub.vf" 15 } } */
/* rsub only provide scalar version.  */
/* { dg-final { scan-assembler-times "vrsub.vx" 36 } } */
/* { dg-final { scan-assembler-times "vrsub.vi" 36 } } */
