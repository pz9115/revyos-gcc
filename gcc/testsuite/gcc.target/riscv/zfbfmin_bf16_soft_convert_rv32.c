...
void di_to_bf () { bf = di; } /* call\t__floatdisf + call\t__truncsfbf2. */

void usi_to_bf () { bf = usi; }

void udi_to_bf () { bf = udi; } /*  call\t__floatundisf + call\t__truncsfbf2. */
...
/* { dg-final { scan-assembler-times "call\t__extendbfsf2" 32 } } */
/* { dg-final { scan-assembler-times "call\t__truncsfbf2" 13 } } */
/* { dg-final { scan-assembler-times "call\t__truncdfbf2" 5 } } */
